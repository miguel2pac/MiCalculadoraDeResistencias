package com.miguel2pac.micalculadoraderesistencias;
...
public class MiCalculadoraDeResistencias extends AppCompatActivity {
    ...
    public double delta;
    public double val1;
    public double val2,val3;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mi_calculadora_de_resistencias);
